  ...
  - heading: Details
    text: |
      <div class="project-details project-details--rich">
        <div class="project-detail"><p class="project-detail-label">Palette</p><ul class="project-mini"><li>Warm off-white architectural panelling</li><li>Neutral bouclé upholstery</li><li>Black accents and dark timber notes</li><li>Natural stone floor as the anchor</li></ul></div>
...
gallery:
  ...
  images:
    - image: /assets/images/projects/98_pc_lobby/lobby_bare.webp
      alt: Lobby view 1
    - image: /assets/images/projects/98_pc_lobby/lobby_bare.webp
      alt: Lobby view 2
    - image: /assets/images/projects/98_pc_lobby/lobby_bare.webp
