...
- **Phase 5 is substantially underway (16–17 July 2026), skipping ahead of Phase 4** (which remains gated on Phase 3's photography-blocked items, not on Phase 5). P5.1 (self-hosted, subsetted fonts), P5.2 (responsive image delivery), P5.3/P5.4 (render-blocking audit, single LCP strategy), P5.5 (technical SEO — share images, structured data, sitemap `lastmod`), P5.6 (security headers, fully verified for public pages), and P5.7 (Decap SRI hash and editorial workflow, partially verified) are all implemented — see each ticket below for exactly what was verified versus what still needs a live owner test. **P5.8 is moot** (the custom visual CMS was already retired, P0.3). **P5.9 needs a legal professional**, not implementation work. **P5.10** (Lighthouse quality budgets) has not been attempted — it needs a production-like deploy to measure meaningfully, not just a local build.
