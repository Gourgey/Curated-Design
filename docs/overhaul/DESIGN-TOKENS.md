...
| `07-misc-pages.css` | Coming-soon badge, Apps pages, Studio legal pages, the thank-you page (`.thanks`, `.thanks__inner`, moved here from `04-homepage.css` — not homepage-specific). |
