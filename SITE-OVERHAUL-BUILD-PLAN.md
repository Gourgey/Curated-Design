...
**Status (July 2026): duplicate-selector reconciliation, breakpoint consolidation, the physical (order-preserving) file split, legacy token-alias retirement, and by-topic regrouping (carousels, and the shared CTA button/band component) are complete.**
