...
"Goods" means furniture, lighting, artwork, accessories, materials, finishes, equipment, or other items sourced, specified, purchased, or arranged for the Project.

"Suppliers" means third-party manufacturers, retailers, trade suppliers, delivery companies, logistics providers, contractors, installers, customs agents, warehouses, or other external providers.
...
- styling and decorative direction;
- installation coordination;
- assembly, dressing and placement;
- project schedules and cost schedules;
- presentation materials, drawings, visuals, renders, or product lists;
- advice relating to layout, finish, product choice, supplier choice, and presentation of a space.

The specific services for each Project will be set out in the relevant Proposal, invoice, payment request, or written agreement.

Any services not expressly included in the agreed scope are excluded unless agreed in writing.

## 4. Proposals, estimates and approval
...
Our fees may include one or more of the following:
...
- trade-discount or savings-based fees;
- expenses and reimbursable costs;
- supplier, delivery, logistics, import, or third-party charges.

The fee structure for each Project will be set out in the relevant Proposal, invoice, payment request, or written agreement.

Where a procurement fee is calculated by reference to trade savings, discounts, supplier pricing, or product value, the calculation method will be stated in the relevant Proposal or invoice.

## 6. Payment terms

Payment terms will be stated on the relevant invoice or payment request.
...
- withhold documents, schedules, drawings, visuals, or other deliverables;
...
## 11. Cancellations, returns and changes
...
This section should be read subject to applicable consumer law and any specific cancellation notice provided to the Client.

## 13. Delivery, access and installation
...
Where installation, styling, or delivery is arranged, the Client must ensure that the site is ready before the agreed date.

Unless otherwise agreed, the site must be:

- clean;
- dry;
- safe;
- accessible;
- free from unrelated contractors where necessary;
- adequately lit;
- sufficiently complete for goods to be installed;
...
## 16. Product variation

The Client accepts that natural materials and handmade items may vary in colour, tone, grain, texture, veining, pattern, finish, shape, size, or appearance.

This includes materials such as stone, timber, leather, metal, ceramic, wool, linen, rattan, glass, plaster, handmade finishes, and vintage or antique items.

Reasonable variation is not a defect.

Colours may also appear differently on screens, printed materials, samples, renders, photographs, and in different lighting conditions.
...
The Client is not automatically entitled to receive the full amount of any trade discount unless this has been expressly agreed in writing.
...
- review proposals, schedules, drawings, and specifications carefully;
- approve costs before orders are placed;
- pay invoices on time;
- disclose relevant site restrictions;
...
Any renders, visuals, sketches, mockups, sample boards, or presentation materials are intended to communicate design direction and may not represent exact final appearance.

They may differ from the final installed result because of:
...
Renders and visuals are illustrative unless expressly stated otherwise.
...
The Client should ensure that valuable goods are insured once delivered to the property or otherwise placed at the Client's risk.
...
- the Client fails to approve decisions within a reasonable time;
...
On termination, the Client must pay for all work completed, goods ordered, supplier commitments, non-cancellable costs, procurement costs, expenses, and fees incurred up to the date of termination.
...
The courts of England and Wales shall have jurisdiction, except where consumer law gives a consumer the right to bring proceedings elsewhere.
`,
  },
  {
    slug: "privacy-notice",
...
- project details, preferences, requirements, and correspondence;
- property images, plans, measurements, layouts, and related project materials;
- supplier, contractor, agent, or consultant contact details;
- records of meetings, calls, approvals, and decisions;
- information provided through website forms, email, phone, social media, or direct communication.

We only collect information that is relevant to our work, client enquiries, projects, business administration, or legal obligations.

## 3. How we collect information

We may collect personal information when you:

- contact us by email, phone, website form, social media, or in person;
- make an enquiry;
- request a proposal or quote;
- become a client;
- approve a project, proposal, invoice, or payment request;
- share project information, property details, images, plans, or measurements;
- communicate with us during a project;
- work with us as a supplier, contractor, consultant, agent, or business contact.

We may also receive personal information from third parties where relevant to a project, such as estate agents, managing agents, contractors, suppliers, delivery companies, landlords, property owners, or other project contacts.
...
- provide proposals, quotes, invoices, and payment requests;
- manage client relationships;
- provide interior design, procurement, styling, installation, and related services;
- understand project requirements;
- source products, materials, furniture, lighting, accessories, or suppliers;
- communicate with suppliers, contractors, delivery companies, and project partners;
- arrange deliveries, installations, site visits, and project meetings;
...
- IT, hosting, email, cloud storage, website, and software providers;
...
## 7. Project images and property information

As part of our work, we may receive or create project-related materials such as photographs, floor plans, layouts, measurements, product schedules, and design documents.

These may include images or information relating to private homes, investment properties, rental properties, commercial spaces, or development projects.

We use these materials to provide our services, prepare proposals, develop designs, manage procurement, and coordinate project delivery.

We will not publish private residential addresses, personal information, or confidential client details without permission.

Where project photography is intended for portfolio, website, social media, awards, press, or marketing use, we will seek permission where appropriate, especially for private residential projects.

## 8. Marketing

We may contact existing or prospective clients, business contacts, suppliers, agents, or professional contacts with relevant business communications.

You can ask us to stop sending marketing or promotional communications at any time by contacting us at:

[info@curateddesign.studio](mailto:info@curateddesign.studio)

We do not sell or rent personal information to third parties for marketing.

## 9. Cookies and tracking

Our website does not currently use cookies for analytics, advertising, tracking, or personalisation.

We do not currently use advertising pixels, behavioural tracking, or third-party analytics tools on the website.

If this changes, we will update this Privacy Notice and, where required, provide a cookie notice or cookie consent mechanism.

Please note that third-party services linked from our website may use their own cookies or tracking technologies. We are not responsible for the privacy practices of third-party websites.
...
- enquiry information may be kept for up to 2 years;
- client and project records may be kept for up to 6 years after the end of the project;
- accounting, invoice, tax, and payment records may be kept for up to 6 years or longer if required by law;
- supplier and contractor records may be kept for as long as needed for business, legal, or accounting purposes;
- marketing preferences may be kept until you unsubscribe or ask us to delete them.

We may keep information for longer where required for legal, tax, insurance, dispute, regulatory, or legitimate business reasons.
...
This may include appropriate technical, organisational, and administrative measures such as secure devices, password protection, access controls, cloud storage safeguards, and careful handling of project documents.

No system is completely secure, but we take privacy and data protection seriously.

## 12. International transfers

Some of the software, hosting, cloud storage, email, or business tools we use may process personal information outside the UK.

Where personal information is transferred internationally, we aim to ensure appropriate safeguards are in place, such as adequacy regulations, contractual protections, or other lawful transfer mechanisms.

## 13. Your rights

Under data protection law, you may have rights in relation to your personal information, including the right to:
...
These rights may be subject to legal limits or exceptions.
...
- Registered office: ${registeredOffice}
- Trading address: ${registeredOffice}
- Email: [info@curateddesign.studio](mailto:info@curateddesign.studio)
- Website: [https://curateddesign.studio](https://curateddesign.studio)
